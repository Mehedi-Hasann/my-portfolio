...
export default function Footer() {
  const socialLinks = [
    {
      name: 'Facebook',
      icon: <path d="M22 12a10 10 0 1 0-11.5 9.9v-7H7.5v-3h3V9.5c0-3 1.8-4.7 4.6-4.7 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 1-2 2v2.4h3.4l-.5 3h-2.9v7A10 10 0 0 0 22 12z"/>,
