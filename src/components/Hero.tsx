      ...
      >
        ...
        <div className="space-y-8">
          <motion.div variants={itemVariants} className="space-y-2">
            <h3 className="text-sm md:text-lg lg:text-xl font-medium text-blue-400 tracking-wide">Hi, I&apos;m</h3>
          ...
          <motion.p 
            ...
            className="text-sm sm:text-base md:text-lg lg:text-xl text-on-surface-variant max-w-2xl leading-relaxed opacity-90"
          >
            <span className="text-blue-400 font-semibold">Competitive Programmer</span> 
            <span className="text-pink-400 font-semibold"> & Backend-Focused Full-Stack Developer <br /><br /></span>Competitive Programmer (350+ Codeforces problems solved) with strong problem-solving skills and a focus on backend systems. I build scalable APIs and high-performance web applications using Express.js, Node.js, TypeScript, and PostgreSQL.
          </motion.p>

          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 pt-2">
            
            <motion.a 
              href="#about"
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px rgba(59, 130, 246, 0.4)" }}
              whileTap={{ scale: 0.98 }}
              className="group relative px-6 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-pink-600 text-white font-bold rounded-full overflow-hidden transition-all shadow-lg flex items-center justify-center text-sm sm:text-base"
            >
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="px-6 sm:px-10 py-2 sm:py-3 glass-card text-on-surface font-semibold rounded-full border border-white/10 hover:border-blue-400/50 transition-all flex items-center justify-center text-sm sm:text-base"
            >
              Let&apos;s Collaborate
            </motion.a>
            <motion.div
                        ...
                        viewport={{ once: true }}
                        className="pt-0 sm:pt-2 w-full sm:w-auto"
                      >
                        <a 
                          href="/Mehedi_Hasan.pdf" 
                          target="_blank"
                          className="w-full sm:w-auto rounded-full inline-flex items-center justify-center px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-pink-600 text-white font-bold shadow-lg hover:shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-95 text-xs sm:text-sm uppercase tracking-widest gap-2"
                        >
        ...
        <div className="relative flex justify-center lg:justify-end perspective-1000">
            <motion.div
              ...
              className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-[420px] md:h-[420px] group"
            >
            {/* Animated Ring */}
            ...
            <div className="relative w-full h-full rounded-full p-4 glass-card border-white/10 overflow-hidden group-hover:border-blue-500/30 transition-colors duration-700">
              <Image 
                ...
                className="object-cover rounded-full grayscale-0 dark:grayscale-[20%] group-hover:grayscale-0 transition-all duration-700"
                priority
              />
            ...
            <motion.div 
              ...
              className="absolute -top-2 -left-4 sm:-top-3 sm:-left-5 md:-left-12 glass-card p-2 sm:p-3 rounded-2xl flex items-center gap-1.5 sm:gap-2.5 z-20 border border-white/10 shadow-[0_0_20px_rgba(59,130,246,0.2)]"
            >
              <a href="https://codeforces.com/profile/Mehethe_hasan" className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-white/5 rounded-xl">
              ...
              <a href="https://codeforces.com/profile/Mehethe_hasan">
                <p className="text-[7px] sm:text-[8px] font-bold text-blue-400 uppercase tracking-widest">Codeforces</p>
                <p className="text-on-surface font-bold text-[10px] sm:text-[11px]">350+ Solved</p>
              </a>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute top-9 -right-5 sm:top-10 sm:-right-6 md:-right-16 glass-card p-2 sm:p-3 rounded-2xl flex items-center gap-1.5 sm:gap-2.5 z-20 border border-white/10 shadow-[0_0_20px_rgba(255,161,22,0.2)]"
            >
              <motion.div className="w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center bg-white/5 rounded-xl">
              ...
              <motion.div>
                <p className="text-[7px] sm:text-[8px] font-bold text-orange-400 uppercase tracking-widest">LeetCode</p>
                <p className="text-on-surface font-bold text-[10px] sm:text-[11px]">50+ Solved</p>
              </motion.div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-9 -right-5 sm:bottom-10 sm:-right-6 md:-right-12 glass-card p-2 sm:p-3 rounded-2xl flex items-center gap-1.5 sm:gap-2.5 z-20 border border-white/10 shadow-[0_0_20px_rgba(236,72,153,0.2)]"
            >
              <motion.div className="w-7 h-7 sm:w-10 sm:h-10 flex items-center justify-center bg-white/5 rounded-xl">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="#5B4638">
              ...
              <motion.div>
                <p className="text-[7px] sm:text-[8px] font-bold text-pink-400 uppercase tracking-widest">CodeChef</p>
                <p className="text-on-surface font-bold text-[10px] sm:text-[11px]">3★ (1615 Max)</p>
              </motion.div>
            </motion.div>
          </motion.div>
        </div>
