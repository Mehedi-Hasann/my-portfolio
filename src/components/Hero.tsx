      ...
      >
        ...
        <div className="space-y-8">
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-3 pt-2">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-10 py-4 bg-gradient-to-r from-blue-600 to-pink-600 text-white font-bold rounded-full overflow-hidden transition-all shadow-lg flex items-center justify-center"
            >
            ...
            <motion.div
                      ...
                      >
                        <a 
                          ...
                          target="_blank"
                          className="w-full rounded-full inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-pink-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-blue-500/20 transition-all hover:scale-[1.02] active:scale-95 text-sm uppercase tracking-widest gap-3"
                        >
        ...
        <div className="relative flex justify-center lg:justify-end perspective-1000">
          ...
          >
            ...
            >
              <motion.div className="w-10 h-10 flex items-center justify-center bg-white/5 rounded-xl">
            ...
            >
              <motion.div className="w-12 h-12 flex items-center justify-center bg-white/5 rounded-xl">
