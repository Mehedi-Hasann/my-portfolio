        ...
        {projects.map((project, idx) => (
          ...
          >
            ...
            <motion.div 
              ...
              className="relative rounded-[2rem] overflow-hidden border border-white/10 glass-card shadow-2xl shadow-blue-900/10"
            >
              {/* Browser Header */}
              <div className="h-10 bg-on-surface/5 border-b border-on-surface/5 flex items-center px-5 gap-2 relative z-20">
                <div className="w-3 h-3 rounded-full bg-red-500/40"></div>
                <div className="w-3 h-3 rounded-full bg-yellow-500/40"></div>
                <div className="w-3 h-3 rounded-full bg-green-500/40"></div>
                <div className="ml-4 flex-1 h-5 bg-on-surface/5 rounded-md flex items-center px-3">
                  <div className="w-20 h-1 bg-on-surface/10 rounded-full"></div>
                </div>
              </div>
              ...
              <div className="relative w-full aspect-[16/10] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-background/40 dark:from-background/60 via-transparent to-transparent opacity-60 group-hover:opacity-40 transition-opacity duration-700"></div>
            ...
            <div className="mt-10 px-4 flex-1 flex flex-col">
              ...
              <div className="mt-auto flex flex-wrap gap-3">
                {project.tags.map(tag => (
                  <span 
                    key={tag} 
                    className="px-4 py-1.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-[12px] font-bold uppercase tracking-widest text-blue-600 dark:text-blue-300 group-hover:text-blue-500 dark:group-hover:text-blue-200 group-hover:bg-blue-500/20 transition-all duration-500"
                  >
                    {tag}
                  </span>
                ))}
