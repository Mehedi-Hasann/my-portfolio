...
export default function About() {
  return (
    <section className="relative py-24 px-6 md:px-12 lg:px-24 max-w-[1400px] mx-auto overflow-hidden font-poppins" id="about">
      {/* Background Orbs */}
        ...
        >
          ...
          <div className="relative w-full aspect-square rounded-[3rem] overflow-hidden mb-12 glass-card border border-white/10 group">
            <Image 
              ...
              className="object-cover transition-transform duration-700 group-hover:scale-105 grayscale-0 dark:grayscale-[10%]"
              priority
            />
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          >
            ...
            <div className="space-y-5 text-on-surface-variant text-lg md:text-xl leading-relaxed opacity-90">
              ...
              <p>
                My experience in <span className="text-pink-400 font-semibold">Competitive Programming</span> (350+ CF solved, 3* CodeChef) has trained me to think critically about efficiency, edge cases and optimization. My expertise spans the modern web stack, from <span className="text-on-surface">Next.js</span> and <span className="text-on-surface">TypeScript</span> to <span className="text-on-surface">Prisma</span> and <span className="text-on-surface">PostgreSQL</span>.
              </p>
              <p>
                I am particularly interested in backend systems, API design and database architecture using <span className="text-blue-400 font-semibold">Node.js</span>. I enjoy working on problems that require structured thinking, performance optimization and reliable system design. I am deeply experienced in designing relational and non-relational database schemas with <span className="text-blue-400 font-semibold">PostgreSQL</span>, 
