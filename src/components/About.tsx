      ...
      <div className="grid lg:grid-cols-12 gap-16 items-start">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 relative z-10">
            {[
              {name: 'Facebook',icon: ( <svg viewBox="0 0 24 24" fill="currentColor"><path d="M22 12a10 10 0 1 0-11.5 9.9v-7H7.5v-3h3V9.5c0-3 1.8-4.7 4.6-4.7 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 1-2 2v2.4h3.4l-.5 3h-2.9v7A10 10 0 0 0 22 12z"/></svg>),href: 'https://www.facebook.com/Mehedihasa67/',},
        ...
        <div className="lg:col-span-8 flex flex-col gap-8">
          ...
          >
            ...
            <div className="space-y-5 text-on-surface-variant text-lg md:text-xl leading-relaxed opacity-90">
              ...
              <p>
                On the backend, I specialize in building robust, high-performance architectures using <span className="text-blue-400 font-semibold">Node.js</span>.
                I am deeply experienced in designing relational and non-relational database schemas with <span className="text-blue-400 font-semibold">PostgreSQL</span>, 
